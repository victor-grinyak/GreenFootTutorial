...
public class SnakeWorld extends World
{
    ...
    /**
     * Конструктор объектов для класса SnakeWorld.
     * 
     */
    public SnakeWorld()
    {    
    ...
    /**
     * upDateCoords
     * Обновляет координаты змейки когда она двигается по экрану
     */
    ...
    /**
     * drawSnake
     * Отрисовывает змейку в стартовой позиции
     */
    ...
    /**
     * placeFood
     * Помещает определенное количество яблок в игровом окне
    ...
    /**
     * setUpCoords
     * Задает стартовые координаты змейки
     */
    ...
    /**
     * addTail
     * Добавляет хвост в конце змейки
     */
    public void addTail()
    {
    ...
    /**
     * keyPress
     * Меняет направление змейки в зависимости от нажатой клавиши
     */
    ...
    /**
     * getBodyPosition
     * возвращает координаты змейки от переданного параметра bodyPosition
    ...
    /**
     * hitEdge - конец игры если змейка коснется края игрового поля
     */
    public void hitEdge()
    {
